 			...
 			<div class="modal-body">
 				<form>
 					<div class="form-group">
 						<label class="font-15">ID Layanan</label>
 						<input type="email" class="form-control" placeholder="ID Layanan">
 					</div>
 					<div class="form-group">
 						<label class="font-15">Nama Layanan Ticket</label>
 						<input type="text" class="form-control" placeholder="Masukkan Nama Layanan Ticket">
 					</div>
 				</form>
 			</div>
