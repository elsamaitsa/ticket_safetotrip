 			...
 			<div class="modal-body">
 				<form>
 					<div class="form-group">
 						...
 						<input type="email" class="form-control" placeholder="ID Group">
 					</div>
 					<div class="form-group">
 						<label class="font-15">Nama Group Ticket</label>
 						<input type="text" class="form-control" placeholder="Masukkan Nama Group Ticket">
 					</div>
 				</form>
 			</div>
